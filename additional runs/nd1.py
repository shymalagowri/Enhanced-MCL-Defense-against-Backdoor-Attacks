...
def test(opt, test_clean_loader, test_bad_loader, nets, criterions, epoch):
    ...
    print_confusion_matrix(y_true_clean, y_pred_clean, "Clean Images")

    # Print confusion matrix for bad images
    print_confusion_matrix(y_true_bad, y_pred_bad, "Bad Images")
...
# Function for fine-tuning without defense
