...
def get_arguments():
    ...
    parser.add_argument('--attack_size', default=10, type=int, help='number of samples for inversion')
    # backdoor attacks
    parser.add_argument('--inject_portion', type=float, default=0.3, help='ratio of backdoor samples')
